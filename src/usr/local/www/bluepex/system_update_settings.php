...
$section->addInput(new Form_Checkbox(
	'disablecheck',
	'Enable Auto-Update',
	'Enable/Disable auto-update packs',
...
if (file_exists("/usr/local/bin/git")) {
	...
	$section->addInput(new Form_Input(
		...
		))->setHelp('The most recently used branch was "%1$s". (Usually the branch name is bp-RELENG_5_0_2)' .
	...
	$group->setHelp(gettext('See "playback gitsync --help" in console "PHP Shell + BluePexUTM tools" for additional information.'));
	$section->add($group);
