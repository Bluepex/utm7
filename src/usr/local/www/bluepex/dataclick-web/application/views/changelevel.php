...
<div class="container">
  <div class="well title">
		<h3 class="text-center"><?=$this->lang->line("utm_template_menu_users_action_role")?></h3>
	</div>
  <div class="panel panel-default">
    <div class="panel-body">
      <div class="text-center">
        <div class="col-lg-4 col-lg-offset-4">
          <h5><?=$this->lang->line("utm_user_hello")?> <span><?php echo $first_name; ?></span>, <br><?=$this->lang->line("utm_user_change_level_text")?></h5>     
