...
<thead>
	<tr>
		...
		<th width="120" align="right">Tempo de conexão (s)</th>
...
<?php
    $total = 0;
	foreach ($data as $obj) :
		$total = $total+$obj->connect_time;
	endforeach;
	foreach ($data as $obj) :
?>
	<tr>
		<td align="left"><?=$obj->username?></td>
		<td align="right"><?=$obj->connect_time?></td>
        <td align="right"><?=(!empty($obj->connect_time) && $total > 0) ? number_format((($obj->connect_time/$total)*100), 2) : '0'; ?></td>
	</tr>
<?php endforeach; ?>
</tbody>
<tfoot>
    <tr>
		<td colspan="2" align="right"><strong><?=$this->lang->line('reports_p_connect_time');?> <?=$total?></strong></td>
		<td></td>
	</tr>
</tfoot>
</table>
