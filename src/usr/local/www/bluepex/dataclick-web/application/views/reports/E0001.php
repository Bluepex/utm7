	...
	<tbody>
		<tr>
			...
			<td width="50%" align="right" valign="top">
				...
				<tbody>
					<tr>
						<td width="80" align="right"><label><?=$this->lang->line('reports_c_utm');?></label></td>
...
<thead>
	<tr>
		<th width="130" align="left"><?=$this->lang->line('reports_c_user');?></th>
		<th align="left"><?=$this->lang->line('reports_c_group');?></th>
		<th width="100" align="right"><?=$this->lang->line('reports_c_access');?></th>
	</tr>
</thead>
<tbody>
	<tr>
		<td width="130" align="left"><?=$user->username?></td>
...
<thead>
	<tr>
		<th width="130" align="left"><?=$this->lang->line('reports_c_date');?></th>
		<th width="600" align="left">Site</th>
		<th align="left"><?=$this->lang->line('reports_c_categ');?></th>
		<th width="100" align="right"><?=$this->lang->line('reports_c_consumer');?></th>
	</tr>
</thead>
<tbody>
<?php
...
<tfoot>
	<tr>
		<td colspan="4" align="right"><strong><?=$this->lang->line('reports_c_totalmb');?> <?=$total?></strong></td>
	</tr>
</tfoot>
</table>
<?php endif; ?>
