 ...
 * Written by Desenvolvimento <desenvolvimento@bluepex.com>, 2016
 *
 * ====================================================================
 *
 */
...
<html>
	<head>
		...
		<style>
			...
			#img-cloud { background: url("../../../images/cloud-key.png"); width:100%; height:515px; background-size: 100%; background-repeat: no-repeat; }
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div id="content">
						...
						<br>
						<p>Desculpe, verificamos que o site não esta de acordo com a política de acesso da segurança da companhia, por essa razão foi preciso bloquea-lo.</p>
						<p>Em caso de dúvidas, por favor contacte o administrador da rede.</p>
						<br />
						<table>
						<tbody>
							<tr>
