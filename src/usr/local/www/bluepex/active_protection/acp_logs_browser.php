...
if ($_POST['action'] == 'load') {
	if(!is_file($logfile)) {
		...
		$data2 = str_replace("Suricata", "ActiveProtection", $data1);
		$data = str_replace("suricata", "ActiveProtection", $data2);
		if($data === false) {
...
$pgtitle = array(gettext("Active Protection"), gettext("Logs & Status"));
