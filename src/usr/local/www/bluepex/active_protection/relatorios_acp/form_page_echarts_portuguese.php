            ...
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <div class='marginTop3Cm divDisplayInline'>
                        <div class="paddingInternal1cm internalWidthHead">
                            ...
                            <div class="divText">
                                ...
                                <h3 class="h3Text noBold"><?=trim(shell_exec("sh /etc/uname_customizaded")) . " " . trim(file_get_contents('/etc/version')) . "," . explode(",",trim(file_get_contents('/etc/sub_version_base')))[1]?></h3>
                            </div>
                            <div class="divText">
                    ...
                    <div class='copyright divColorWhite centerPage'>
                        ...
                        <p>&copy; <?=date("Y");?> BluePex CyberSecurity S/A - Todos os direitos reservados.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    <div class='divDisplayInline'>
                        ...
                        <div class="marginHeader60 centerText marginTextHeader"><h6>Relatório Active Protection</h6></div>
                    ...
                    <div class='divDisplayInline'>
                        <div class="internalWidthHead">
                            <div class="divText">
                                <p><b>Modelo:</b> <?=trim(file_get_contents("/etc/model"))?></p>
                                <p><b>Versão:</b> <?=trim(file_get_contents('/etc/version')) . " (" . reset(bp_list_files_pack_fix('inverse', true)) . ") "?></h3>
                                <p><b>Chave do produto:</b> <?=getProductKey()?></h3>
                            </div>
                        </div>
                        <div class="internalWidthHead">
                            <div class="divText">
                                ...
                                <p><b>Data referente (de):</b> <?=date('d/m/Y', strtotime("-{$range_time_value} day", strtotime('now')))?></p>
                                <p><b>Data referente (até):</b> <?=date('d/m/Y', strtotime('-1 day', strtotime('now')))?></p>
                                <p><b>Serial:</b> <?=trim(file_get_contents("/etc/serial"))?></p>
                            </div>
                        </div>
                    </div>
                    <hr class="hrBoldLine">
                    <h6>Origens de tentativas de invasão (Filtro LOG)</h6>
                    <div id="chart-map-threats" style="height:360px;border:0px solid #fff;padding:-10px;"></div>
                    <br>
                    <br>
                    <br>
                    <!--<hr>-->
                    <h6 class="h6LeftText">Países de origem das tentativas de invasão (TOP 10)</h6>
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>Estas informações são referentes a geolocalização dos endereços filtrados como suspeitos e/ou ameaças reais pelas interfaces em geral.</li>
                        </ul>
                    </div>
                    <div class='copyright'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Origens de ameaças de invasão (Filtro ACP)</h6>
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>Estas informações são referentes a geolocalização dos endereços filtrados como suspeitos e/ou ameaças reais pelas interfaces executando o Active Protection.</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <p>Os níveis de riscos listados são referentes as regras em operação do Active Protection que operam de forma preventiva, sendo assim, tráfegos potencialmente nocivos são bloqueados, porém são registrados como "tentativas", segue abaixo a classificação:</p>
                        <ul>
                            <li>Alto Risco: Acesso identificado como possivelmente nocivo e bloqueado;</li>
                            <li>Médio Risco: Acesso identificado como duvidoso, sua ação não é bloqueada, porém é colocada em alerta;</li>
                            <li>Baixo Risco: Acesso identificado com baixo potencial de risco e somente é alertado;</li>
                            <li>Mínimo Risco: Acesso identificado como livre de riscos e pode trafegar normalmente;</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Registros por tipo</h6>
                    <div id="qtdValuesfilter" style="height:200px;width:auto;margin:auto;"></div>
                    <br>
                    <h6 class="h6LeftText">Riscos listados por tipo</h6>
                    <div class='tableReport'>
                        <table class="table table-bordered mt-lg-4">
                            <thead>
                                <tr>
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>Filtro LOG: Referente ao acesso geral de todas as interfaces com acesso externo;</li>
                            <li>Filtro ACP: Referente a todos os acessos registros pelo Active Protection;</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Quantidade acessos diário (Filtro ACP)</h6>
                    <div id="qtdAccessTimeLineACP" style="height:360px;margin:auto;"></div>
                    <br>
                    <br>
                    <br>
                    <!--<hr>-->
                    <h6 class="h6LeftText">Datas listadas (TOP 10)</h6>
                    <div class='tableReport'>
                        <table class="table table-bordered mt-lg-4">
                            <thead>
                                <tr>
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>O gráfico e a tabela demonstram quantidade de acessos registrados na determinada data, isso é, independente se o acesso foi interrompido ou liberado.</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Quantidade acessos diário (Filtro LOG)</h6>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Principais Alertas Acusados ​​(Filtro ACP) (TOP 5)</h6>
                    <div id="qtdAccessRulefilterACP" style="height:360px;margin:auto;"></div>
                    <br>
                    <br>
                    <br>
                    <!--<hr>-->
                    <h6 class="h6LeftText">Alertas listados (TOP 10)</h6>
                    <div class='tableReport'>
                        <table class="table table-bordered mt-lg-4">
                            <thead>
                                <tr>
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>Os alertas apresentados foram os mais 'acionados' durante o período de tempo, estes alertas são referentes a regras em execução no Active Protection;</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Principais endereços internos mais acessadas (Filtro ACP) (TOP 5)</h6>
                    <div id="qtdIPInternalfilterACP" style="height:360px;margin:auto;"></div>
                    <br>
                    <br>
                    <br>
                    <!--<hr>-->
                    <h6 class="h6LeftText">Ips Internos listados (TOP 10)</h6>
                    <div class='tableReport'>
                        <table class="table table-bordered mt-lg-4">
                            <thead>
                                <tr>
                            ...
                            <tbody id="qtdTableIPInternalfilterACP">
                            </tbody>
                        </table>
                    </div>
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>Os IP's internos registrados são referentes aos que mais sofreram tentativas de acesso externo, podendo ser tentativas legitimas ou acessos indevidos;</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Principais portas internas mais acessadas externamente (Filtro ACP) (TOP 5)</h6>
                    <div id="qtdPortInternalfilterACP" style="height:360px;margin:auto;"></div>
                    <br>
                    <br>
                    <br>
                    <!--<hr>-->
                    <h6 class="h6LeftText">Portas Internas listadas (TOP 10)</h6>
                    <div class='tableReport'>
                        <table class="table table-bordered mt-lg-4">
                            <thead>
                                <tr>
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>As portas listadas são referentes as que mais tiveram tentativas de acesso de forma externa aos serviços internos;</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Principais endereços externos acessados (Filtro ACP) (TOP 5)</h6>
                    <div id="qtdIPAccessExternalfilterACP" style="height:360px;margin:auto;"></div>
                    <br>
                    <br>
                    <br>
                    <!--<hr>-->
                    <h6 class="h6LeftText">Ips Externos listados (TOP 10)</h6>
                    <div class='tableReport'>
                        <table class="table table-bordered mt-lg-4">
                            <thead>
                                <tr>
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>Os IP's externos são referentes a tentativas de conexões da rede interna a externa, sendo que os endereços listados são aqueles que houveram mais requisições que podem ter sido bem sucedidas ou interrompidas;</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Principais portas externas acessadas (Filtro ACP) (TOP 5)</h6>
                    <div id="qtdPortExternalfilterACP" style="height:360px;margin:auto;"></div>
                    <br>
                    <br>
                    <br>
                    <!--<hr>-->
                    <h6 class="h6LeftText">Portas externas mais acessadas (TOP 10)</h6>
                    <div class='tableReport'>
                        <table class="table table-bordered mt-lg-4">
                            <thead>
                                <tr>
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>As portas externas normalmente são fornecidas de forma dinâmica pelo provedor do site/serviço devido as demandas dos mesmos, esteja ciente que uma determinada não necessariamente será a mesma no proximo acesso a um mesmo serviço.</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Acessos por protocolo (Filtro ACP) (TOP 5)</h6>
                    <div id="qtdProtocolfilterACP" style="height:360px;margin:auto;"></div>
                    <br>
                    <br>
                    <br>
                    <!--<hr>-->
                    <h6 class="h6LeftText">Protocolos listados (TOP 10)</h6>
                    <div class='tableReport'>
                        <table class="table table-bordered mt-lg-4">
                            <thead>
                                <tr>
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>Os protocolos listados são aqueles detectados pelo Active Protection;</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Acessos por protocolo (Filtro LOG) (TOP 5)</h6>
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>Os protocolos listados são aqueles detectados pelo uso geral das interfaces com acesso externo;</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
        ...
        <div class="row pb-0">
            <div class="pl-0 pr-0 pr-xl-6 col-xl-6 col-md-12 col-sm-12">
                <div class="pageSizeReport">
                    ...
                    <hr class="hrBoldLine">
                    <h6>Acessos por Interface (Filtro LOG) (TOP 5)</h6>
                    <div id="qtdInterfacefilterLOG" style="height:360px;margin:auto;"></div>
                    <br>
                    <br>
                    <br>
                    <!--<hr>-->
                    <h6 class="h6LeftText">Iinterfaces listadas (TOP 10)</h6>
                    <div class='tableReport'>
                        <table class="table table-bordered mt-lg-4">
                            <thead>
                                <tr>
                    ...
                    <div class='observationBox'>
                        <p>Observação:</p>
                        <ul>
                            <li>As interfaces listadas são aqueles que foram detectadas que realizaram acessos externos;</li>
                        </ul>
                    </div>
                    <div class='copyright'>
                        <hr class="hrBoldLine" style='margin-top: 100%;'>
...
for (var key in valuesJson) {
    if (!isNaN(key)) {
        ...
        if (key == 1) {
            nameRisk = "Alto Risco";
            tabletBase += "<td style='vertical-align: middle;'><p>Alto Risco</p></td>";    
        } else if (key == 2) {
            nameRisk = "Médio Risco";
            tabletBase += "<td style='vertical-align: middle;'><p>Médio Risco</p></td>";    
        } else if (key == 3) {
            nameRisk = "Baixo Risco";
            tabletBase += "<td style='vertical-align: middle;'><p>Baixo Risco</p></td>";          
        } else {
            nameRisk = "Mínimo Risco";
            tabletBase += "<td style='vertical-align: middle;'><p>Mínimo Risco</p></td>";        
        }
...
option = {
    ...
    series: [
        ...
        name: '<?=gettext("Quantidade de registros")?>',
        type: 'bar',
        barWidth: '60%',
        label: {
            show: true,
...
option = {
	...
	yAxis: {
	  	type: 'category',
	  	data: ["<?=gettext("TOP Alertas acusados")?>"]
	},
	series: series_teste
};
option && myChart.setOption(option);
...
option = {
	...
	yAxis: {
	  	type: 'category',
	  	data: ["<?=gettext("TOP endereços externos acessados")?>"]
	},
	series: series_teste
};
option && myChart.setOption(option);
...
option = {
	...
	yAxis: {
	  	type: 'category',
	  	data: ["<?=gettext("TOP IP's Internos acessados")?>"]
	},
	series: series_teste
};
option && myChart.setOption(option);
...
option = {
	...
	yAxis: {
	  	type: 'category',
	  	data: ["<?=gettext("TOP Portas externas acessdas")?>"]
	},
	series: series_teste
};
option && myChart.setOption(option);
...
option = {
	...
	yAxis: {
	  	type: 'category',
	  	data: ["<?=gettext("TOP Portas internas acessdas")?>"]
	},
	series: series_teste
};
option && myChart.setOption(option);
