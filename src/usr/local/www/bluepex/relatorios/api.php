...
require_once("relatorios.inc");
require_once("relatorios_report.inc");
require_once("relatorios_webfilter.inc");
...
function get_report_data($params)
{
	...
	switch ($params['report']) {
		case "P0001":
			$data = get_sshd($params);
			break;
		case "P0002":
			$data = get_relatorios_top_5_social_access($params);
			break;
		case "P0003":
			$data = get_relatorios_top_categories($params);
			break;
		case "P0004":
			$data = get_relatorios_top_10_domains($params);
			break;
		case "P0005":
			$data = get_relatorios_top_10_accessed_sites($params);
			break;
		case "P0006":
			$data = get_alerts_access($params,0);
			break;
		case "P00061":			
			$data = get_alerts_access($params,1);
			break;
		case "P0007":
		case "P0008":
		case "P0009":
		case "P0010":
			$data = get_relatorios_top_access_social_networks($params);
			break;
		case "0001":
...
{
	/* noop function inherited from dataclick.  Not needed here */
	return true;
}
