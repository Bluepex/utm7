...
$pgtitle = array(gettext("FirewallApp"), gettext("Analyze signature / traffic"));
...
<div class="infoblock">
	<div class="alert alert-info clearfix" role="alert">
		<div class="pull-left">
			<p>informativo:</p>
			<p>Esta página tem como objetivo apresentar e analisar todo o trafego de rede pelas interfaces acionadas com o FirewallAPP.</p>
			<br>
...
<div class="panel-body" style="margin-bottom:60px;">
	<div class="table-responsive">
		...
		<button type="click" onclick="modal_form_get_address()" class="btn btn-primary form-control" style="width: auto; float:right;" title='Buscar pelo endereço de domínio da conexão'><i class="fa fa-sitemap"></i> </button>
