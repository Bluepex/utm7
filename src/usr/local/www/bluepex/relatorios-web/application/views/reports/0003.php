...
<thead>
	<tr>
		...
		<th width="120" align="right"><?=$this->lang->line('reports_c_port');?></th>
		...
		<th width="80" align="right">% (<?=$this->lang->line('reports_c_temp');?>)</th>
	</tr>
</thead>
<tbody>
<?php
...
?>
	<tr>
		...
		<td align="right"><?=(!empty($obj->connected_time) && $total > 0) ? number_format((($obj->connected_time/$total)*100), 2) : '0'; ?></td>
	</tr>
<?php endforeach; ?>
</tbody>
<tfoot>
