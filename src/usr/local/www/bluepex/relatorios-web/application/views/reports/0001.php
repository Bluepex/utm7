...
<thead>
	<tr>
		...
		<th width="120" align="right"><?=$this->lang->line('reports_c_access');?></th>
		<th width="120" align="right"><?=$this->lang->line('reports_c_consumer');?></th>
...
?>
	<tr>
		...
		<td align="right"><?=(!empty($user->total_consumed) && $total > 0) ? number_format((($user->total_consumed/$total)*100), 2) : '0'; ?></td>
	</tr>
<?php endforeach; ?>
</tbody>
<tfoot>
